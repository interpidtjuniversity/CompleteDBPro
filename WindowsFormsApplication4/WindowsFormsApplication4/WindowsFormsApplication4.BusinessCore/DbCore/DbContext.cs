...
public class DbContext<T> where T : class, new()
{
    public DbContext()
    {
        ...
        {
            ConnectionString = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=DESKTOP-NMHKGJH.mshome.net)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=PDBorcl)));Persist Security Info=True;User ID=scott;Password=m1234;",
